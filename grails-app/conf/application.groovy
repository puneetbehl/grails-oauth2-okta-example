...
grails.plugin.springsecurity.oauth2.providers.okta.userInfoUrl = 'https://${OKTA_SUB_DOMAIN}.okta.com/oauth2/v1/userinfo'
grails.plugin.springsecurity.oauth2.providers.okta.authorizeUrl = 'https://${OKTA_SUB_DOMAIN}.okta.com/oauth2/v1/authorize'
grails.plugin.springsecurity.oauth2.providers.okta.tokenUrl = 'https://${OKTA_SUB_DOMAIN}.okta.com/oauth2/v1/token'
