...
grails.plugin.springsecurity.oauth2.providers.okta.api_key = '${OKTA_CLIENT_ID}'
grails.plugin.springsecurity.oauth2.providers.okta.api_secret = '${OKTA_CLIENT_SECRET}'
grails.plugin.springsecurity.oauth2.providers.okta.userInfoUrl = 'https://${OKTA_CLIENT_SUBDOMAIN}.okta.com/oauth2/v1/userinfo'
grails.plugin.springsecurity.oauth2.providers.okta.authorizeUrl = 'https://${OKTA_CLIENT_SUBDOMAIN}.okta.com/oauth2/v1/authorize'
grails.plugin.springsecurity.oauth2.providers.okta.tokenUrl = 'https://${OKTA_CLIENT_SUBDOMAIN}.okta.com/oauth2/v1/token'
